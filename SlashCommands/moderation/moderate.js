const Client = require('../../index'),
    ...
    db = require('../../models/muteroleModel')
...
//        if (client.owners.includes(member.id)) return interaction.followUp({ content: 'I cannot moderate the owner of the bot.', ephemeral: true })

        let embed = new MessageEmbed()
        .setColor("BEIGE")
        .setDescription('Please choose an action.')
        ...
        await interaction.followUp({ embeds: [embed], components: components(false) })
