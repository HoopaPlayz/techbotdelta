...
module.exports = {
    ...
    run: async(client, message, args) => { //change all this previous lines to your normal parameters
        if(message.author.id != 693717845275574292) return message.channel.send("This can only be ran by the bot owner!") //add your id without quotes
